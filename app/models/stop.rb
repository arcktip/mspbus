class Stop < ActiveRecord::Base
  ...
  attr_accessible :id, :stop_id, :source_id, :stop_name, :stop_desc, :stop_lat, :stop_lon, :stop_city, :stop_street, :url, :stop_type, :stop_code, :zone_id, :stop_url, :stop_region, :stop_postcode
